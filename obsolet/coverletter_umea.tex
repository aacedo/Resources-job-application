...
\recipient
  ...
  {Faculty of Science and Technology\\Umeå University\\SE-901 87\\Umeå, Sweden}
% The date on the letter, default is the date of compilation
\letterdate{\today}
% The title of the letter
\lettertitle{Job Application for Post-Doctoral Position in Mathematical Statistics}

% How the letter is opened
\letteropening{Dear Professors Dr. Cronie and Dr. Rydén}
