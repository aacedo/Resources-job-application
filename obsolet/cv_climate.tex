...
\makecvfooter
  {\today}
  {Luis F. Santa G.~~~·~~~Curriculum Vitae}
  {\thepage}
...
\input{cv/grants.tex}
\input{cv/reser_experience.tex}
\input{cv/teac_experience.tex}
\input{cv/super_experience.tex}
\input{cv/writing.tex}
\input{cv/presentation.tex}
\input{cv/add_experience.tex}
\input{cv/skills.tex}
\input{cv/referees1.tex}
